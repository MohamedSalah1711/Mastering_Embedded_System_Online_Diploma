...
#define I2C1_ER_NVIC_EN()					NVIC_ISER1 |= (1 << (I2C1_ER_IRQ-32))
#define I2C2_EV_NVIC_EN()					NVIC_ISER1 |= (1 << (I2C2_EV_IRQ-32))
#define I2C2_ER_NVIC_EN()					NVIC_ISER1 |= (1 << (I2C2_ER_IRQ-32))
...
//-*-*-*-*-*-*-*-*-*-*-*-
//Disable NVIC Macros I2C:
//-*-*-*-*-*-*-*-*-*-*-*
#define I2C1_EV_NVIC_Dis()					NVIC_ICER0 |= (1 << I2C1_EV_IRQ)
#define I2C1_ER_NVIC_Dis()					NVIC_ICER1 |= (1 << (I2C1_ER_IRQ-32))
#define I2C2_EV_NVIC_Dis()					NVIC_ICER1 |= (1 << (I2C2_EV_IRQ-32))
#define I2C2_ER_NVIC_Dis()					NVIC_ICER1 |= (1 << (I2C2_ER_IRQ-32))
//-*-*-*-*-*-*-*-*-*-*-*-
//Generic Macros:
//-*-*-*-*-*-*-*-*-*-*-*
#define NULL 						((void *)0)
