...
#define EXTI9_5_NVIC_ENABLE()				NVIC_ISER0|=(1<<23)
#define EXTI9_5_NVIC_DISABLE()				NVIC_ICER0|=(1<<23)
#define EXTI15_10_NVIC_ENABLE()				NVIC_ISER1|=(1<<8)
#define EXTI15_10_NVIC_DISABLE()			NVIC_ICER1|=(1<<8)
