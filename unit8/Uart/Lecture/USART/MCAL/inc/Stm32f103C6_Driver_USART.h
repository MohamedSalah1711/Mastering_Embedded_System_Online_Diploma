...
#define Transmitt_Enable		(1u)
#define Recevier_Enable			(1u)
...
#define DIV_FRACTION(_PCLK_,_BAUD_)			(uint32)(((USARTDIVMUL100(_PCLK_,_BAUD_) - MantissaMul100(_PCLK_,_BAUD_) ) *16)/100)
